// Données du site - générées automatiquement depuis les fichiers YAML
window.siteData = {
  "general": {
    "site_name": "Dvorah Avocat",
    "site_title": "Dvorah Avocat - Cabinet d'avocats spécialisé",
    "site_description": "Cabinet d'avocats spécialisé en droit pénal, droit économique et droit international",
    "phone": "+33 1 23 45 67 89",
    "email": "contact@dvorah-avocat.fr",
  ...
  "expertise": {
    ...
    "subtitle": "Notre cabinet vous accompagne dans tous vos besoins juridiques avec une expertise pointue et reconnue.",
    "domains": [
      {
        "title": "Droit pénal",
        "description": "Défense pénale et accompagnement juridique dans toutes les procédures pénales, de l'enquête au jugement.",
      ...
      },
      {
        ...
        "description": "Conseil et défense en matière de droit des affaires, droit de la concurrence et droit économique.",
      ...
      },
      {
        ...
        "description": "Expertise en droit international et accompagnement dans les procédures transfrontalières.",
      ...
      },
      {
        ...
        "description": "Spécialisation dans la défense en matière de cybercriminalité et protection des données.",
      ...
      },
      {
        ...
        "description": "Protection de la réputation, droit de la presse et liberté d'expression.",
  ...
  "cabinet": {
    "title": "Le Cabinet",
    "subtitle": "Une équipe d'avocats expérimentés à votre service",
    "team": [
      {
        "name": "Maître Dvorah",
        "title": "Avocate au Barreau de Paris",
        "description": "Avocate expérimentée spécialisée en droit pénal et droit des affaires, Maître Dvorah met son expertise au service de ses clients depuis plus de 10 ans. Elle accompagne ses clients avec rigueur et professionnalisme dans toutes leurs démarches juridiques.",
        "quote": "Notre mission est de défendre vos droits avec excellence et intégrité, en vous offrant un accompagnement personnalisé et des solutions juridiques adaptées."
      }
    ]
  },
  "contact": {
